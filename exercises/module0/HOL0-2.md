...
To have more control over the options you can open the menu by clicking the elipsis at the right of the dialog. Choose `New with options...` from the menu. 
...
<img src="./../images//hol0-1.Csoptions.png" width="700" />
...
When the codespace is created, you can also choose to use your own Visual Studio Code environment to run the remote codespace. 
...
If you have installed Visual Studio Code, you can connect to your Codespace from there. Go to your own repository. Then go to the Code button and open your codespace in VS Code.
