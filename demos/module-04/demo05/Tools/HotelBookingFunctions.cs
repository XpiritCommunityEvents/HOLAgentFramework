...
public static class HotelBookingFunctions
{
    ...
    public static AvailableRoom[] FindAvailableRooms(
        ...
        int id)
    {
        ...
        return string.Equals(consent, "yes", StringComparison.OrdinalIgnoreCase);
    }
    ...
    private static readonly AvailableRoom[] availableRooms =
    {
        ...
        new AvailableRoom { RoomId = 305, RoomType = "Deluxe", PricePerNight = 210.00m, HotelName = "Harbor View", NumberOfAdultsAllowedInRoom = 3, Amenities = "Free WiFi, TV, Mini Bar", City = "Ibiza" },
        new AvailableRoom { RoomId = 306, RoomType = "Suite", PricePerNight = 400.00m, HotelName = "Harbor View", NumberOfAdultsAllowedInRoom = 4, Amenities = "Free WiFi, TV, Mini Bar, Ocean View", City = "Ibiza" },
        ...
        new AvailableRoom { RoomId = 310, RoomType = "Standard", PricePerNight = 130.00m, HotelName = "Skyline Hotel", NumberOfAdultsAllowedInRoom = 2, Amenities = "Free WiFi, TV, City View", City = "Ibiza" },
        ...
        new AvailableRoom { RoomId = 320, RoomType = "Deluxe", PricePerNight = 205.00m, HotelName = "Urban Stay", NumberOfAdultsAllowedInRoom = 3, Amenities = "Free WiFi, TV, Mini Bar", City = "Sant Josep de sa Talaia" },
        ...
        new AvailableRoom { RoomId = 325, RoomType = "Standard", PricePerNight = 135.00m, HotelName = "Royal Palace", NumberOfAdultsAllowedInRoom = 2, Amenities = "Free WiFi, TV, Air Conditioning", City = "Sant Josep de sa Talaia" },
        new AvailableRoom { RoomId = 326, RoomType = "Deluxe", PricePerNight = 225.00m, HotelName = "Royal Palace", NumberOfAdultsAllowedInRoom = 3, Amenities = "Free WiFi, TV, Mini Bar, Air Conditioning", City = "Sant Josep de sa Talaia" },
        new AvailableRoom { RoomId = 327, RoomType = "Suite", PricePerNight = 380.00m, HotelName = "Royal Palace", NumberOfAdultsAllowedInRoom = 4, Amenities = "Free WiFi, TV, Mini Bar, Kitchenette, Air Conditioning", City = "Sant Josep de sa Talaia" },
