    ...
    public class HotelPlugin()
    {
        ...
        private AvailableRoom[] availableRooms = new AvailableRoom[]
        {
            ...
            new AvailableRoom
            {
                ...
                NumberOfAdultsAllowedInRoom = 4,
                Amenities = "Free WiFi, TV, Air Conditioning, Mini Bar, Kitchenette",
                City = "Paris"
            },
            new AvailableRoom
{
