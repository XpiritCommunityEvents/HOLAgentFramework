# Demo 1 - Text Prediction with an LLM

This is a demonstration of text prediction using a large language model (LLM). Start VS Code and open a new Markdown file
